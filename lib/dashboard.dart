...
//just one image each
List<String> pendingTasksOnClicked = ['image/slideshow1.png', 'image/slideshow1.png', 'image/slideshow1.png'];
//add corresponding url of each site
List<String> pendingTasksURL= ['https://www.fbla-pbl.org/','https://www.fbla-pbl.org/','https://www.fbla-pbl.org/'];



List<String> eventsImage = ['image/SLC.png', 'image/MODWalk.png', 'image/NLC.png'];
...
//just one image each
List<String> eventsOnClicked = ['image/slideshow1.png', 'image/slideshow1.png', 'image/slideshow1.png'];
//add corresponding url of each site
List<String> eventsURL= ['https://www.fbla-pbl.org/','https://www.fbla-pbl.org/','https://www.fbla-pbl.org/'];
